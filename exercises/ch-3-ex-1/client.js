...
app.get('/authorize', function (req, res) {
  // Clear the global access_token variable
  access_token = null;

  // Generate random state string and assign the global state variable
...
app.get('/callback', function (req, res) {
  console.log('Incoming request: /callback');
  ...
  if (tokRes.statusCode >= 200 && tokRes.statusCode < 300) {
    ...
    // Assign the global access_token variable
